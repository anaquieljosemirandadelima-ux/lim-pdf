...
const routes = ["/", "/ferramentas", "/ferramentas/juntar-pdf", "/ferramentas/compactar-pdf", "/ferramentas/preencher-formulario-pdf", "/faq", "/privacidade", "/cookies", "/seguranca", "/sitemap.xml", "/robots.txt", "/ads.txt", "/.well-known/security.txt"];
