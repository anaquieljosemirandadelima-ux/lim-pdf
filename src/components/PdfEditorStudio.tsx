...
export function PdfEditorStudio() {
  ...
  async function exportPdf() {
    ...
    try {
      ...
      prepareOutput(new Blob([outputBuffer], { type: "application/pdf" }), `${file.name.replace(/\.pdf$/i, "")}-studio-lim-pdf.pdf`);
      setStatus("ready");
