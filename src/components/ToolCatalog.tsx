...
const sections: Array<{ id: CatalogSection; title: string; accent: string; icon: typeof Repeat2; tools: AllToolSlug[] }> = [
  ...
  { id: "converter", title: "Converter arquivos", accent: "teal", icon: sectionIcons.converter, tools: ["pdf-para-word", "pdf-para-excel", "pdf-para-jpg", "pdf-para-png", "extrair-texto-pdf", "word-para-pdf", "excel-para-pdf", "imagens-para-pdf", "pdf-em-escala-de-cinza"] },
