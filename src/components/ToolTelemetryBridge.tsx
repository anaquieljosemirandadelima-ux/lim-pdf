...
import { bytesBucket, measurementConsentGranted, sendToolMetric, timeBucket, type TelemetryToolSlug } from "@/lib/tool-telemetry";
...
export function ToolTelemetryBridge({ toolSlug }: { toolSlug: TelemetryToolSlug }) {
